<script>
   ...
   async function snagArtists() {
     const q = query(collection(db, "artists"), where("accepted", "==", true));
   ...
   async function snagSongs() {
      const q = query(collection(db, "songs"), where("accepted", "==", true));
   ...
   async function snagAlbums() {
      const q = query(collection(db, "albums"), where("accepted", "==", true));
